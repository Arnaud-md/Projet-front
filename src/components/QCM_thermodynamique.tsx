...
const QCM_thermodynamique = () => {
    ...
    useEffect(()=> {
        const quizzCreation = async()=> {
            const response = await fetch(('http://localhost:'+port+'/api/quizz/thermodynamique'), {
                headers: new Headers({
    ...
    export default QCM_thermodynamique;